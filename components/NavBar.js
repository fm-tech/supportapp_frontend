        ...
        <div 
            className="antialiased bg-gray-100 dark-mode:bg-gray-900">
                ...
                dark-mode:text-gray-200 dark-mode:bg-gray-800">
                    ...
                    mx-auto md:items-center md:justify-between md:flex-row md:px-6 lg:px-8">
                        ...
                        <nav className="flex-col flex-grow hidden pb-4 md:pb-0 md:flex md:justify-end md:flex-row">
                            <Link href='/tickets'>
                            <a className="px-4 py-2 mt-2 text-sm font-semibold bg-transparent rounded-lg 
                            ...
                            md:ml-4 hover:text-gray-900 focus:text-gray-900 hover:bg-gray-200 focus:bg-gray-200 
                            focus:outline-none focus:shadow-outline" href="#">Tickets</a>
                            </Link>
                            <Link href='/ticket/submit'>
                            <a className="px-4 py-2 mt-2 text-sm font-semibold bg-transparent rounded-lg 
                            dark-mode:bg-transparent dark-mode:hover:bg-gray-600 dark-mode:focus:bg-gray-600 
                            dark-mode:focus:text-white dark-mode:hover:text-white dark-mode:text-gray-200 md:mt-0 
                            md:ml-4 hover:text-gray-900 focus:text-gray-900 hover:bg-gray-200 focus:bg-gray-200 
                            focus:outline-none focus:shadow-outline" href="#">Submit</a>
                            </Link>
                        </nav>
                    </div>
                </div>
